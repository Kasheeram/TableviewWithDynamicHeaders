...
protocol ReasonHeaderViewDelegate: class {
    func reasonToggleSection(header: ReasonHeader, section: Int)
}

class ReasonHeader: UITableViewHeaderFooterView {

    weak var delegate: ReasonHeaderViewDelegate?
    var section: Int = 0
...
//    }()
    ...
    @objc private func didTapHeader() {
        delegate?.reasonToggleSection(header: self, section: section)
    }
